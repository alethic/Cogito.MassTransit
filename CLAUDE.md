...
Cogito.MassTransit — Extensions and utilities for working with MassTransit.

Publishes 3 packages: `Cogito.MassTransit`, `Cogito.MassTransit.Extensions`, `Cogito.MassTransit.Scheduler`.
