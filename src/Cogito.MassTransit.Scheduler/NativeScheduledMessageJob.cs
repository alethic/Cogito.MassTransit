namespace Cogito.MassTransit.Scheduler
{
    ...
    public class NativeScheduledMessageJob :
        global::Quartz.IJob
    {
        ...
        public NativeScheduledMessageJob()
        {

        }

        public NativeScheduledMessageJob(IBus bus)
        {
            _bus = bus;
        }
        ...
        static void SetObjectProperties(ScheduledMessageData job, global::Quartz.JobDataMap jobData)
        {
